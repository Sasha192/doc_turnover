...
@Service
public class CreationTaskApplicationEventService
        implements ITaskApplicationEventService<TaskCreationEvent> {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreationTaskApplicationEventService) {
            return true;
        }
        return false;
    }
